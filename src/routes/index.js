  ...
  const usersRouter = require("./users.routes");  // importando o usersRouter do "./users.routes" - grupo de rotas do usuario
  const routes      = Router();                   // colocando a funcao dentro da variavel e criando a rota

  routes.use("/users", usersRouter);    // usando a nova rota - Redirecionando para a rota do usuario - USERS.ROUTES.JS
